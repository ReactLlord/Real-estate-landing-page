  ...
  return (
   ...
   <Navbar/>
        ...
        className='container text-center mx-auto py-4 px-6 md:px-20 text-white'>
            <h2 className='text-5xl sm:text-6xl md:text-[82px] inline-block max-w-3xl font-semibold pt-20' style={{transform:'translateY(-25%'}}>Explore homes that fit your dreams</h2>
